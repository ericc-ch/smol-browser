...
Proof: 5 consecutive green `cargo nextest run --workspace --exclude obscura-render` runs plus 1 stress run at `--test-threads 8` on this machine; `e2e/run.sh` green (33/34 required, `observer-intersection` documented fail).
