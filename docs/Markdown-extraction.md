...
```bash
tinybrowser fetch https://docs.example.com/page --dump markdown -o page.md
```

## For RAG / LLM context

```bash
tinybrowser fetch https://docs.example.com/page --dump markdown --quiet
```
...
```bash
tinybrowser fetch https://example.com --selector "main" --dump markdown
tinybrowser fetch https://example.com --selector "article.post" --dump markdown
```
