...
Embeddable Rust API for the [tinybrowser](https://github.com/h4ckf0r0day/obscura)
...
compiles tinybrowser from source, including its embedded V8 (`deno_core`), so the
first build is large and slow.

```toml
[dependencies]
tinybrowser-lib = { git = "https://github.com/h4ckf0r0day/obscura", features = ["api"] }
